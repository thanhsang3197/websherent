...
export function NewArrivalsSection({ products }: { products: Product[] }) {
  ...
  return (
    <section className="container-content py-10">
      ...
      <div
        className="relative mt-6 overflow-hidden motion-reduce:overflow-x-auto motion-reduce:[-ms-overflow-style:none] motion-reduce:[scrollbar-width:none] motion-reduce:[&::-webkit-scrollbar]:hidden"
      ...
      >
        <ul
          className="flex w-max gap-4 motion-safe:animate-marquee-right"
          style={{
